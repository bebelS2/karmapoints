...
public class LoginFinan {
    ...
    private void initialize() {
        frame = new JFrame();
        frame.setTitle("Login como Financiador Externo");
        ...
        JLabel labelTitulo = new JLabel("Faça login como Financiador Externo:");
        constraints.gridx = 0;
        constraints.gridy = 1;
        constraints.gridwidth = 2;
    ...
    private void realizarLogin() {
        ...
        String query = "SELECT * FROM financiador WHERE email = ? AND senha = ?";
        try (PreparedStatement statement = connection.prepareStatement(query)) {
            ...
            if (resultSet.next()) {
                int idFinanciadorLogado = resultSet.getInt("idFinan");

                // Armazenar o ID do financiador logado na classe UserData
                UserData userData = UserData.getInstance();
                userData.setIdFinanciadorLogado(idFinanciadorLogado);

                JOptionPane.showMessageDialog(frame, "Login realizado com sucesso!");
                fecharJanela(); // Fecha a janela de login

                // Abrir a InterfaceFinan
