...
public class InscricaoTrabalhos extends JFrame {
    ...
    private void initialize() {
        ...
        JLabel labelIdTrab = new JLabel("ID do Trabalho que deseja se inscrever:");
        textFieldIdTrab = new JTextField(10);
        JButton buttonExcluir = new JButton("Inscrever-se");
    ...
    private void loadTableData() {
        try (Statement statement = connection.createStatement()) {
            String sql1 = "SELECT * FROM trabalho";
            ...
            int[] columnWidths = { 100, 200, 150, 100, 300, 200, 100 };
    ...
    private void confirmarExclusao() {
        ...
        if (idTrabText.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Informe o ID do Trabalho que quer se inscrever.");
            return;
        }

        int confirmacao = JOptionPane.showConfirmDialog(this, "Tem certeza que deseja inscrever-se neste Trabalho?");
        if (confirmacao == JOptionPane.YES_OPTION) {
            inscreverTrabalho();
        }
    }

    private void inscreverTrabalho() {
        String idTrabText = textFieldIdTrab.getText();
        try {
            int idTrab = Integer.parseInt(idTrabText);
            int idVol = getIdVolLogado();
            String sql = "insert into inscricao (idTrab, idVol) values (?, ?)";
            try (PreparedStatement statement = connection.prepareStatement(sql)) {
                ...
                if (rowsAffected > 0) {
                    JOptionPane.showMessageDialog(this, "Trabalho inscrito com sucesso.");
                    loadTableData();
                    limparCampoIdTrab();
                } else {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(this, "Erro ao inscrever-se em trabalho.");
        }
    }
