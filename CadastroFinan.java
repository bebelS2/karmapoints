...
public class CadastroFinan {
    ...
    private void initialize() {
        frame = new JFrame();
        frame.setTitle("Cadastro como Financiador");
        ...
        JLabel labelTitulo = new JLabel("Cadastre-se como Financiador Externo:");
        constraints.gridx = 0;
        constraints.gridy = 1;
        constraints.gridwidth = 2;
    ...
    private void cadastrarFinan() {
        ...
        String query = "INSERT INTO financiador (nome, cnpj, telefone, email, senha) VALUES (?, ?, ?, ?, ?)";
        try (PreparedStatement statement = connection.prepareStatement(query)) {
            ...
            ex.printStackTrace();
            JOptionPane.showMessageDialog(frame, "Erro ao cadastrar a Financiador Externo: " + ex.getMessage());
        }
    }
